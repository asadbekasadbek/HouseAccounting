...
<div class="title h1"><h1>Дом Бухгатерия ({{ Auth::user()->name }} ) <a href="#" onclick="location.reload();"><button type="button" class="btn btn-outline-success">обновить таблицу по шагам</button></a>
 </h1></div>
...
<table class="table">
   ...
   <div class="title">
         <a class="a" href="/home/category/changes/{{ Auth::user()->id}}"><button type="button" class="btn btn-outline-warning cc">Текущие изменения по датам</button></a>

    <a href="{{route('home.create')}}"><button type="button" class="btn btn-outline-success">Добавить таблицию</button></a>
   </div>
